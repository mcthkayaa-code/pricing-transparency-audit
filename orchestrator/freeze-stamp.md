...
**Generated 2026-08-17 by `tools/freeze_stamp.py`. Every figure below is read from the files it describes, not typed.**

Generated against commit **`673c85b1e7bc`** — necessarily the commit *before* this stamp is itself committed. A reader verifying the hashes should check out that commit, or accept that this file is the only difference.
...
| `9a937b0b739286e8` | 21,804 | `limitations-register.md` |
| `116b5d1b8cd894f1` | 14,988 | `methods-who-coded.md` |
| `239a6a37b30a12e5` | 22,123 | `methods-tooling-failure-modes.md` |
| `c6c9faabffd47649` | 11,788 | `analysis-first-findings.md` |

## What this stamp does NOT cover

**Owner sign-off.** The pre-freeze checklist requires it before anything is published, and it is separate from this stamp. Freezing stops the data moving; publishing is a decision.
